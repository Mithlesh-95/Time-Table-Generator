      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="mt-8 p-4 bg-blue-50 rounded-md">
          ...
          <div className="text-xs text-blue-700 space-y-1">
            ...
            <p><strong>Dept Admin:</strong> deptadmin / admin123</p>
            <p><strong>Faculty:</strong> faculty / admin123</p>
            <p><strong>Student:</strong> student / admin123</p>
          </div>
        </div>
      </div>
    </div>
