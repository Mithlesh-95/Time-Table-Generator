...
def create_sample_data():
    ...
    # Create faculty
    faculty_data = [
        {"first_name": "John", "last_name": "Doe", "email": "john.doe@college.edu", "department": cs_dept},
        {"first_name": "Jane", "last_name": "Smith", "email": "jane.smith@college.edu", "department": cs_dept},
        {"first_name": "Bob", "last_name": "Wilson", "email": "bob.wilson@college.edu", "department": ee_dept},
        {"first_name": "Alice", "last_name": "Brown", "email": "alice.brown@college.edu", "department": me_dept},
    ]
    ...
    # Create subjects
    subjects_data = [
        {"code": "CS101", "name": "Programming Fundamentals", "category": "Major", "credits_theory": 3, "credits_practical": 1},
        {"code": "CS201", "name": "Data Structures", "category": "Major", "credits_theory": 3, "credits_practical": 1},
        {"code": "EE101", "name": "Circuit Analysis", "category": "Major", "credits_theory": 3, "credits_practical": 0},
        {"code": "ME101", "name": "Engineering Drawing", "category": "Major", "credits_theory": 2, "credits_practical": 2},
        {"code": "ENG101", "name": "English Communication", "category": "AEC", "credits_theory": 2, "credits_practical": 0},
    ]
    ...
    students_data = [
        {"first_name": "Student1", "last_name": "CS", "email": "student1@college.edu", "enrollment_no": "CS2023001", "department": cs_dept, "current_semester": "Sem-1"},
        {"first_name": "Student2", "last_name": "CS", "email": "student2@college.edu", "enrollment_no": "CS2023002", "department": cs_dept, "current_semester": "Sem-1"},
        {"first_name": "Student3", "last_name": "EE", "email": "student3@college.edu", "enrollment_no": "EE2023001", "department": ee_dept, "current_semester": "Sem-1"},
        {"first_name": "Student4", "last_name": "ME", "email": "student4@college.edu", "enrollment_no": "ME2023001", "department": me_dept, "current_semester": "Sem-1"},
    ]
