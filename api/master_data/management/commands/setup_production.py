...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        self.stdout.write(
            self.style.SUCCESS('🚀 Setting up Time-Table-Generator for production...')
        )
    ...
    def load_sample_data(self):
        ...
        try:
            ...
            self.stdout.write(
                self.style.WARNING('You can load it manually later with: python manage.py add_timetable_data')
            )
